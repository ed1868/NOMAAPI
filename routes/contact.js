...
let emailAdmin = (emailData) => {
  ...
  transporter.sendMail({
    ...
    to: "ainomadsmiami@gmail.com",
    subject: "NEW AI NOMADS REQUEST",
    html: `
        <!doctype html>
        ...
        @media only screen and (max-width:480px) {
          ...
          <div
             style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;"
          ><p style="line-height: 60px; text-align: center; margin: 10px 0;font-size:55px;color:#1C99FE;font-family:'Times New Roman',Helvetica,Arial,sans-serif"><b>New Request!</b></p></div>
          ...
          >
            <tr>
              ...
              >
                ...
                <br>
                <br>
                <span style="color:#212020">Email : ${email}</span>
                <br>
                <br>
                <span style="color:#212020">Phone : ${phone}</span>
           <br>
           <br>
           <span style="color:#212020">Name : ${name}</span>
           <br>
           <br>
           <span style="color:#212020">Subject : ${subject}</span>
           <br>
           <br>
           <span style="color:#212020">Text : ${text}</span>
  ...
  transporter.sendMail({
    ...
    html: `
        ...
        @media only screen and (max-width:480px) {
          ...
          <div
             style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;"
          ><p style="line-height: 60px; text-align: center; margin: 10px 0;font-size:55px;color:#1C99FE;font-family:'Times New Roman',Helvetica,Arial,sans-serif"><b>Thank you for reaching out!</b></p></div>
          ...
          <div
             style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;"
          ><p style="line-height: 30px; text-align: center; margin: 10px 0;color: white;font-size:25px;font-family:'Times New Roman',Helvetica,Arial,sans-serif"><b>We will reach out to you with your current inquiry in less than 24 hours<br></br>
                </p></div>
