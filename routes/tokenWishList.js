...
let emailAdmin = (emailData) => {
  ...
  transporter.sendMail({
    from: '"NEW TOKEN USER ADDED TO WAITLIST" <myawesome@project.com>',
    ...
    html: `
        ...
        @media only screen and (max-width:480px) {
          ...
          <div
             style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;"
          ><p style="line-height: 60px; text-align: center; margin: 10px 0;font-size:55px;color:#1C99FE;font-family:'Times New Roman',Helvetica,Arial,sans-serif"><b>SAVE THIS USER!</b></p></div>
          ...
          >
           ...
           <br>
           <br>
           <span style="color:#212020">Name : ${firstName}</span>
